...
import 'package:recipesbook/models/recipe_model.dart';
import 'package:recipesbook/views/recipe_view.dart';
...
class _HomeState extends State<Home> {
  ...
  showRecipes() async {
    ...
    String url =
        "https://api.edamam.com/search?q=${textEditingController.text}&app_id=d72551cb&app_key=a76b4011bc70d23cdcd00b14138de0a4&to=50";
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      "Just Enter Ingredients you have and we will show the best recipes for you. You can enter multiple Ingredients with comma(,)",
                      style: TextStyle(
                        fontSize: 15,
                        color: Colors.white,
